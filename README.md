...
- **The review queue** appears once a day has been flown. Points are frozen at answer time, so the day freezes too: every guess with its count and verdict, accept, reject, retier, merge one spelling into another. A ruling re-scores only the pilots who gave that answer.
